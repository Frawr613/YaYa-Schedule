(function (global) {
  ...
  const originalEffectAnchors = {
    ...
    theme: ["玻璃变量", "暗色玻璃变量", "暗色基底识别", "暗色透明哑光玻璃", "标题卡日程卡同步", "标题左右按钮同步", "标题/小日程默认透明度隔离", "暗色反光降噪", "主题预设", "自定义主题栏", "独立自定义主题面", "模板-主题桥接", "输入组件主题变量", "模块语义色", "状态色", "应用图标"],
  ...
  const layers = [
    ...
    },
    {
      ...
      owns: ["主题预设", "自定义主题栏", "独立自定义主题面", "详细变量", "状态色", "玻璃感", "暗色玻璃感", "暗色基底识别", "暗色透明哑光玻璃", "标题卡日程卡同步", "标题左右按钮同步", "标题/小日程默认透明度隔离", "暗色反光降噪", "圆角阴影", "输入组件主题变量"],
      provides: ["CSS 变量", "功能状态色", "静态主题预览", "自定义主题一次性应用", "模板主题桥接变量", "暗色日程卡槽位", "标题卡日程卡同步槽位", "标题左右按钮同步槽位", "标题/小日程默认透明度槽位", "暗色页面/浮窗反光槽位", "底层暗色透明哑光玻璃变量", "输入组件主题同步变量"],
