(function (global) {
  ...
  const originalEffectAnchors = {
    ...
    components: ["顶部状态", "DDL 条", "DDL 分页面板", "已完成 DDL 检索面板", "今日面板", "课程/考试/日程概览", "课程概览打开时本学期定位", "考试概览打开时本学期定位", "考试概览 chip 自动定位", "考试概览学期分页", "考试信息收口", "课程选课人数隐藏", "状态分组概览卡", "主题配色面板", "模板化内置输入/选项组件"],
