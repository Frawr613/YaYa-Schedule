(function (global) {
  ...
  const originalEffectAnchors = {
    ...
    interaction: ["玻璃浮窗", "本地丝滑弹出动画", "独立自定义主题面", "底部/侧边抽屉", "日期时间选择器", "模板输入浮层", "内置选项弹层", "滚动锁定", "顶层滚动白名单", "教务页内确认浮窗", "视窗锁定拖动"],
  ...
  const layers = [
    ...
    },
    {
      ...
      owns: ["浮窗层级", "独立自定义主题面", "底部抽屉", "侧边抽屉", "居中面板", "选择器浮层", "滚动隔离", "顶层滚动白名单", "滑动操作", "重渲染保护"],
      provides: ["modalLayout", "density", "浮窗置顶", "下层冻结", "轻触反馈", "繁忙降噪"],
