(function (global) {
  ...
  function customTodaySlots(dark, accentRgb, warmRgb) {
    ...
    return Object.fromEntries(slots.flatMap((slot, index) => {
      ...
      const name = names[index];
      return [
        [`--tpl-today-${name}-bg`, `radial-gradient(circle at 92% 8%, rgba(${left}, 0.055), transparent 44%), linear-gradient(145deg, rgba(71, 85, 105, 0.34), rgba(30, 41, 59, 0.32) 52%, rgba(15, 23, 42, 0.26)), rgba(30, 41, 59, 0.34)`],
        [`--tpl-today-${name}-left`, `rgba(${left}, 0.88)`],
  ...
  function custom(vars = {}) {
    ...
    return bridge(customTodaySlots(dark, accentRgb, warmRgb), {
      ...
      "--tpl-body": `linear-gradient(135deg, rgba(${accentRgb}, ${dark ? "0.035" : "0.1"}), rgba(${warmRgb}, ${dark ? "0.026" : "0.08"})), linear-gradient(180deg, rgba(255, 255, 255, ${dark ? "0.012" : "0.58"}), rgba(255, 255, 255, ${dark ? "0" : "0.08"}))`,
      "--tpl-ink": ink,
      ...
      "--tpl-ddl-mini-text": "#ffffff",
      "--tpl-ddl-mini-border": "rgba(255, 255, 255, 0.42)",
      "--tpl-ddl-mini-shadow": `0 8px 18px rgba(${accentRgb}, ${dark ? "0.055" : "0.14"}), inset 0 1px 0 rgba(255, 255, 255, ${dark ? "0.025" : "0.3"})`,
      "--tpl-border": dark ? "rgba(255, 255, 255, 0.18)" : "rgba(255, 255, 255, 0.52)",
      "--tpl-border-dark": `rgba(${accentRgb}, 0.2)`,
      "--tpl-shadow": dark ? `0 16px 34px rgba(0, 0, 0, 0.14), 0 6px 18px rgba(${accentRgb}, 0.045)` : `0 18px 42px rgba(${accentRgb}, 0.12)`,
      "--tpl-shadow-strong": dark ? `0 22px 46px rgba(0, 0, 0, 0.18), 0 8px 20px rgba(${accentRgb}, 0.055)` : `0 24px 58px rgba(${accentRgb}, 0.18)`,
      "--tpl-inset": dark ? "inset 0 1px 0 rgba(255, 255, 255, 0.018), inset 0 -1px 0 rgba(255, 255, 255, 0.012)" : "inset 0 1px 0 rgba(255, 255, 255, 0.46)",
      "--tpl-page-sheen": dark ? `linear-gradient(180deg, rgba(148, 163, 184, 0.018), rgba(148, 163, 184, 0) 58%), linear-gradient(135deg, rgba(${accentRgb}, 0.022), rgba(${warmRgb}, 0.014), transparent)` : `linear-gradient(180deg, rgba(255, 255, 255, 0.64), rgba(255, 255, 255, 0.22) 58%, rgba(255, 255, 255, 0)), linear-gradient(135deg, rgba(${accentRgb}, 0.055), rgba(${warmRgb}, 0.04), rgba(37, 99, 235, 0.025))`,
      "--tpl-modal-sheen": dark ? "none" : "linear-gradient(115deg, transparent 0%, rgba(255, 255, 255, 0.34) 16%, rgba(255, 255, 255, 0.08) 28%, transparent 46%)",
      "--tpl-item-highlight": dark ? "none" : "radial-gradient(circle at 94% 0%, rgba(255, 255, 255, 0.32), transparent 38%)",
      "--tpl-item-wash": dark ? "linear-gradient(145deg, rgba(71, 85, 105, 0.12), rgba(15, 23, 42, 0.08))" : "linear-gradient(145deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.04))",
      "--tpl-item-shadow": dark ? "0 14px 28px rgba(0, 0, 0, 0.14)" : "0 14px 30px rgba(15, 23, 42, 0.09)",
      "--tpl-badge-bg": dark ? `color-mix(in srgb, var(--item-color, ${accent}) 14%, rgba(30, 41, 59, 0.42))` : "color-mix(in srgb, var(--item-color, var(--accent)) 14%, rgba(255, 255, 255, 0.72))",
      ...
      "--glass": dark ? "rgba(30, 41, 59, 0.36)" : "rgba(255, 255, 255, 0.48)",
      "--glass-strong": dark ? "rgba(30, 41, 59, 0.46)" : "rgba(255, 255, 255, 0.64)",
      "--glass-soft": dark ? "rgba(51, 65, 85, 0.2)" : "rgba(255, 255, 255, 0.3)",
      "--glass-border": dark ? "rgba(148, 163, 184, 0.16)" : "rgba(255, 255, 255, 0.58)",
      "--glass-sheen": dark ? "transparent" : "rgba(255, 255, 255, 0.72)",
      "--glass-panel-bg": dark ? `linear-gradient(145deg, rgba(71, 85, 105, 0.24), rgba(${accentRgb}, 0.045)), rgba(30, 41, 59, 0.36)` : "var(--tpl-surface-strong)",
      "--glass-card-bg": dark ? `linear-gradient(145deg, rgba(71, 85, 105, 0.2), rgba(${accentRgb}, 0.035)), rgba(30, 41, 59, 0.3)` : "var(--tpl-card)",
      "--glass-control-bg": dark ? `linear-gradient(145deg, rgba(71, 85, 105, 0.2), rgba(${accentRgb}, 0.035)), rgba(30, 41, 59, 0.34)` : "var(--tpl-input)",
      "--input-ui-bg": dark ? `linear-gradient(145deg, rgba(71, 85, 105, 0.2), rgba(${accentRgb}, 0.035)), rgba(30, 41, 59, 0.34)` : "var(--tpl-input)",
      "--input-ui-panel": dark ? `linear-gradient(145deg, rgba(71, 85, 105, 0.24), rgba(${accentRgb}, 0.045)), rgba(30, 41, 59, 0.36)` : "var(--tpl-surface-strong)",
